...
class ApiController extends Controller
{
    ...
    public function ranking(){
    	...
    	$ranking = entregas_usuarios::join("usuarios","entregas_usuarios.usuario_id","=","usuarios.id_usuario")->select(DB::raw("@row:=@row+1 as 'posicao'"),"usuarios.nome as usuario",DB::raw('COALESCE(SUM(peso),0) as quantidade_entregue'))->groupby("id_usuario")->orderby("total_entrega","desc")->get();
